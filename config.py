...
VAD_HOP_SIZE = 256
VAD_SILENT_THRESHOLD = 15         #How may frames should wait before send to whisper
VAD_SEND_THRESHOLD = 1000000      #Send if audio data accumulated number exceed threshold, 1000000 is around 5 seconds
VAD_AVG_SCORE_THRESHOLD = 0.2     #The threshold is used to determine whether it is a speech activity in a single speech frame by calculating the avg result return by VAD_THRESHOLD
...
VAD_MIN_THRESHOLD = 300000        #Minimum length to transcribe

#SERVER
SERVER_HOST = "0.0.0.0"
SERVER_PORT = 10928
SERVER_RELOAD = False             #For debug and dev purpose, suggest False in production environment

#AUDIO
AUDIO_SAMPLE_RATE = 48000            #Input audio sampling rate
